...
function get20s(array){
  ...
  for (let i = 0; i < array.length; i++) {
   if(array[i].years.includes("1907")) {
     nextArray.push(array[i].name)
   } 
   if (array[i].years.includes("1904")) {
     nextArray.push(array[i].name)
   }
  }
...
function addArtist(array){
  let artist = {
    ...
    bio: "My name is Erika and some of the people I look up to are Steve Irwin, Elle Woods, and Dolly Parton.  "
  }
  array.push(artist);
  return array
}
